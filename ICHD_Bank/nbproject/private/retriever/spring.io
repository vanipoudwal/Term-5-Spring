...
<link media="all" rel="stylesheet" type="text/css" href="/css/main-5d767fa70203b96f702cfe5b24cd8141.css" />
...
<meta content="Spring makes Java simple." property="og:title" />
...
<img alt="Spring" class="block" id="springlogo" src="/images/spring-logo-9146a4d3298760c2e7e49595184e1975.svg" />
</a>
...
<ul>
<li><a href="/why-spring" tabindex="3">Overview</a></li>
<li><a href="/microservices" tabindex="4">Microservices</a></li>
<li><a href="/reactive" tabindex="5">Reactive</a></li>
<li><a href="/event-driven" tabindex="6">Event Driven</a></li>
<li><a href="/cloud" tabindex="7">Cloud</a></li>
<li><a href="/web-applications" tabindex="8">Web Applications</a></li>
<li><a href="/serverless" tabindex="9">Serverless</a></li>
<li><a href="/batch" tabindex="10">Batch</a></li>
</ul>
</div>
<div class="drop-menu" id="learn-items">
<div class="drop-target" id="learn-target"></div>
<ul>
<li><a href="/learn" tabindex="12">Overview</a></li>
<li><a href="/quickstart" tabindex="13">Quickstart</a></li>
<li><a href="/guides" tabindex="14">Guides</a></li>

<li><a href="/blog" tabindex="16">Blog</a></li>
</ul>
</div>
<div class="drop-menu" id="project-items">
<div class="drop-target" id="project-target"></div>
<ul>
<li><a href="/projects" tabindex="18">Overview</a></li>
<li><a href="/projects/spring-boot" tabindex="19">Spring Boot</a></li>
<li><a href="/projects/spring-framework" tabindex="20">Spring Framework</a></li>
<li><a href="/projects/spring-cloud" tabindex="21">Spring Cloud</a></li>
<li><a href="/projects/spring-cloud-dataflow" tabindex="22">Spring Cloud Data Flow</a></li>
<li><a href="/projects/spring-data" tabindex="23">Spring Data</a></li>
<li><a href="/projects/spring-integration" tabindex="24">Spring Integration</a></li>
<li><a href="/projects/spring-batch" tabindex="25">Spring Batch</a></li>
<li><a href="/projects/spring-security" tabindex="26">Spring Security</a></li>
<li><a class="blue mb-2 inline-block" href="/projects" tabindex="27">View all projects</a></li>
<li class="uppercase smallest">Development Tools</li>
<li><a href="/tools" tabindex="28">Spring Tools 4</a></li>
<li><a href="https://start.spring.io" tabindex="29">Spring Initializr <svg class="external-link-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="15 10.94 15 15 1 15 1 1 5.06 1" stroke="currentColor" stroke-miterlimit="10" stroke-width="2"></polyline><polyline fill="none" points="8.93 1 15 1 15 7.07" stroke="currentColor" stroke-miterlimit="10" stroke-width="2"></polyline><line fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="2" x1="15" x2="8" y1="1" y2="8"></line></svg></a></li>
</ul>
</div>
<div class="drop-menu" id="community-items">
<div class="drop-target" id="community-target"></div>
<ul>
<li><a href="/community" tabindex="33">Overview</a></li>
<li><a href="/events" tabindex="34">Events</a></li>
<li><a href="/team" tabindex="35">Team</a></li>
</ul>
</div>
</div>
</nav>
...
<li><a href="https://start.spring.io">Spring Initializr <svg class="external-link-icon" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><polyline fill="none" points="15 10.94 15 15 1 15 1 1 5.06 1" stroke="currentColor" stroke-miterlimit="10" stroke-width="2"></polyline><polyline fill="none" points="8.93 1 15 1 15 7.07" stroke="currentColor" stroke-miterlimit="10" stroke-width="2"></polyline><line fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="2" x1="15" x2="8" y1="1" y2="8"></line></svg></a></li>
</ul>
</div>
<a class="mobile-link block" href="/training"><div class="mobile-title antialiased">Training</div></a>
<a class="mobile-link block" href="/support"><div class="mobile-title antialiased">Support</div></a>
...
<a class="button uppercase transparent animate" href="/why-spring">Why Spring</a>
<a class="button uppercase transparent animate" href="/quickstart">Quickstart</a>
</div>
</div>
</div>
<div class="content" role="main">
<div class="container">
<div class="flex jc-between mx-auto" id="news">
<div class="new-tag uppercase inline-block grow-0">News</div>
<div class="flex jc-between" id="subnews">
<a class="news-item blue link-animate grow-0" href="/blog/2020/02/14/announcing-the-new-spring-website">Announcing: The NEW Spring Website!</a>
<div class="vdivider"></div>
<a class="news-item blue link-animate grow-0" href="https://springone.io">SpringOne 2020 goes virtual</a>
</div>
</div>
</div>
<hr class="light mt-0" />
<br />
<section aria-label="What Spring can do" class="mb-5" role="contentinfo">
<div class="container">
...
<a class="card block quarter border-box center border mb-2 rad-5 shadow-hover" href="/microservices">
<div class="mw-100">
<svg aria-hidden="true" class="icon-microservices" data-icon="icon-microservices" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
...
<a class="card block quarter border-box center border mb-2 rad-5 shadow-hover" href="/reactive">
<div class="mw-100">
<svg aria-hidden="true" class="icon-reactive" data-icon="icon-reactive" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
<g>
<path d="M92.5,38.3c0-0.9-0.2-1.7-0.6-2.5C91,34,89.4,32.3,87,30.9c-2.8-1.6-6.6-2.9-11.2-3.8
		...
		c-2.6-0.7-4.9-1.6-6.7-2.7c-2.1-1.2-3.6-2.6-4.3-4.2C7.6,44.4,11.8,40.5,15,38.3z" fill="currentColor"></path>
<path d="M44.6,44.2c1.2,0.7,2.7,1.1,4.3,1.3c1,0.1,2,0.1,3,0c1.6-0.2,3.1-0.6,4.3-1.3c1.2-0.7,2-1.6,2.2-2.5
		c0.2-0.6,0.2-1.1,0-1.7c-0.3-0.9-1-1.8-2.3-2.5c-1.2-0.7-2.7-1.1-4.3-1.3c-1-0.1-2-0.1-3,0c-1.6,0.2-3.1,0.6-4.3,1.3
		c-1.2,0.7-2,1.6-2.2,2.5c-0.2,0.6-0.2,1.1,0,1.7C42.6,42.7,43.3,43.5,44.6,44.2z" fill="currentColor"></path>
</g>
<rect fill="none" height="100" width="100"></rect>
</svg>
</div>
...
<a class="card block quarter border-box center border mb-2 rad-5 shadow-hover" href="/cloud">
<div class="mw-100">
<svg aria-hidden="true" class="icon-cloud" data-icon="icon-cloud" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
<path d="M81.7,43.2c-3-11.1-10.9-21.9-19.6-26.9c-5.6-3.2-10.9-3.8-15-1.7c-0.9-1-1.9-1.8-3.1-2.5
	...
	l-0.7-0.4c0-0.4,0-0.9,0-1.3C72.3,70.2,66.4,60.3,59,55.9z" fill="currentColor"></path>
<rect fill="none" height="100" width="100"></rect>
</svg>
</div>
...
<a class="card block quarter border-box center border mb-2 rad-5 shadow-hover" href="/web-applications">
<div class="mw-100">
<svg aria-hidden="true" class="icon-webapps" data-icon="icon-webapps" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
...
<a class="card third block quarter border-box center border mb-2 rad-5 shadow-hover" href="/serverless">
<div class="mw-100">
<svg aria-hidden="true" class="icon-serverless" data-icon="icon-serverless" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
<path d="M77.2,52.3c-0.4-0.2-0.9-0.1-1.1,0.3c0,0,0,0,0,0L59.8,80.1c-0.2,0.4-0.1,0.9,0.3,1.1c0.1,0.1,0.3,0.1,0.4,0.1
	c0.3,0,0.6-0.2,0.7-0.4l16.2-27.5C77.7,53,77.6,52.5,77.2,52.3C77.2,52.3,77.2,52.3,77.2,52.3z" fill="currentColor"></path>
<path d="M71.4,74.9c-0.4-0.2-0.9-0.1-1.1,0.3c0,0,0,0,0,0l-6.8,11.6c-0.2,0.4-0.1,0.9,0.3,1.1C63.9,88,64,88,64.2,88
	c0.3,0,0.6-0.2,0.7-0.4L71.7,76C71.9,75.6,71.8,75.1,71.4,74.9z" fill="currentColor"></path>
<path d="M77.2,36.7c0.4-0.2,0.5-0.7,0.3-1.1c-0.1-0.1-0.2-0.2-0.3-0.3l-10-5.8l4.3-14.9l0,0c0.2-0.1,0.3-0.3,0.3-0.6
	...
	l11.9-6.8L45.3,87.5z" fill="currentColor"></path>
<rect fill="none" height="100" width="100"></rect>
</svg>
</div>
...
<a class="card third block quarter border-box center border mb-2 rad-5 shadow-hover" href="/event-driven">
<div class="mw-100">
<svg aria-hidden="true" class="icon-streams" data-icon="icon-streams" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
<path d="M73.8,15.9c-5.4-3.1-10.5-3.6-14.3-1.4c-0.2,0.1-0.4,0.3-0.6,0.4L21,37.4l-0.2,0.1c-0.1,0-0.1,0.1-0.2,0.1
	...
	l1.2-0.7c1.2-0.6,2.6-0.9,4-0.9c2.9,0.1,5.7,1,8.2,2.5C83.4,23.1,91.8,37.7,91.8,49.5z" fill="currentColor"></path>
<rect fill="currentColor" height="5" width="5" x="38.1" y="67.1"></rect>
<rect fill="currentColor" height="6.5" width="6.5" x="3.3" y="61.9"></rect>
<path d="M62.5,37.2h8v-8h-8L62.5,37.2z M64,30.7h5v5h-5V30.7z" fill="currentColor"></path>
<rect fill="currentColor" height="3.2" width="3.2" x="92.8" y="25"></rect>
<rect fill="currentColor" height="3.2" width="3.2" x="77.6" y="38.3"></rect>
<rect fill="currentColor" height="3.2" width="3.2" x="86.1" y="42.3"></rect>
<rect fill="currentColor" height="3.2" width="3.2" x="74.3" y="47.4"></rect>
<rect fill="none" height="100" width="100"></rect>
</svg>
</div>
...
<a class="card third block quarter border-box center border mb-2 rad-5 shadow-hover" href="/batch">
<div class="mw-100">
<svg aria-hidden="true" class="icon-batch" data-icon="icon-batch" focusable="false" role="img" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
<path d="M88.1,27.8L53.2,7.7c-0.2-0.1-0.5-0.1-0.8,0c-0.2,0.1-0.4,0.4-0.4,0.7V17l-7.5-4.3c-0.2-0.1-0.5-0.1-0.8,0
	...
	c0.2-0.1,0.3-0.3,0.4-0.6c0-0.2-0.1-0.5-0.2-0.6c-0.8-0.7-1.4-1.6-1.8-2.5c-0.1-0.3-0.4-0.4-0.7-0.4h-4.4v-3.7L19,61.5L19,61.5z
	 M32.9,80.8v-3.4h7.8v3.4v4.8v2h-7.8L32.9,80.8z M18,78.6v-6.6l2.3,1.3l0.8,0.4l2,1.2v0.2V85L18,82.1V78.6z" fill="currentColor"></path>
<path d="M29.9,67.8c1.5,0.8,3.1,1.3,4.7,1.5c0.2,0,0.5,0.1,0.8,0.1h0.8c0.2,0,0.5,0,0.7,0c2.4,0,4.8-0.5,6.9-1.7
	...
	c-1.7,0.2-3.3,0.7-4.8,1.5c-2,1.1-3.1,2.7-3,4.4S27.9,66.6,29.9,67.8z" fill="currentColor"></path>
<rect fill="none" height="100" width="100"></rect>
</svg>
</div>
...
<section aria-label="What have we here?" class="container mb-5" role="contentinfo">
<div class="flex jc-between" id="whathavewe">
...
<section aria-label="Quote" class="mb-7" role="contentinfo">
<div class="container">
<img alt="" " class="big-quote" src="/images/quote-08c1b712d6a6f2a891a0c524f236ca60.svg" />
...
<img alt="Taylor Wicksell" class="rad-50" title="Taylor Wicksell" src="/images/wicksell-dbd69bebcb1a4151a1fdb92809f4c830.jpg" />
<div>
...
<img alt="" id="circle-grid" src="/images/footer-circles-dc4b03d4edc1f3b7b42a45bdcce411c8.svg" />
<div class="third">
<h2 class="bold h3 antialiased">Get ahead</h2>
<p>VMware offers training and certification to turbo-charge your progress.</p>
<a class="blue link-animate" href="/training">Learn more</a>
</div>
<div class="third">
...
<a class="blue link-animate" href="/support">Learn more</a>
</div>
<div class="third">
<h2 class="bold h3 antialiased">Upcoming events</h2>
<div class="footer-event">
<a class="blue link-animate" href="https://springone.io">SpringOne</a>
...
<div id="spring-links">
<img alt="Spring" id="springlogo-foot" src="/images/spring-logo-9146a4d3298760c2e7e49595184e1975.svg" />
